...
exports.pushOracleClient = void 0;
...
class pushOracleClient {
     ...
     */
    getCreateOracleIx(uiPrice, expo, conf) {
    ...
    createOracle(uiPrice, expo, conf) {
        return __awaiter(this, void 0, void 0, function* () {
            const [createOracleIx, priceFeed] = yield this.getCreateOracleIx(uiPrice, expo, conf);
...
exports.pushOracleClient = pushOracleClient;
